...
function Footer() {
    return (
        <div className="max-w-[1440px] mx-aut bg-footer bg-opacity-70 flex flex-col items-center text-center gap-12 py-20">
            ...
            <ul className="flex gap-12">
                <li>
                    <a
                        href="#"
                        className="font-barlow font-fw-barlow text-graphic text-[1.15rem] hover:text-white transition-colors duration-300"
                    >
                        About
                    </a>
                </li>
                ...
                <li>
                    ...
                    >
                        <path
                            ...
                            fill="#2C7566"
                            className="hover:fill-white cursor-pointer transition-all duration-300 ease-in-out"
                        />
                    </svg>
                </li>
                <li>
